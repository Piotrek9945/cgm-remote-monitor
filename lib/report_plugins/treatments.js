...
treatments.report = function report_treatments(datastorage, sorteddaystoshow, options) {
  ...
  sorteddaystoshow.forEach(function (day) {
    ...
    for (var t=0; t<treatments.length; t++) {
      var tr = treatments[t];
      var foods = tr.boluscalc.foods;

      if (datastorage.foodfiltername !== null && foods != null && foods.findIndex(function(el) {el._id === datastorage.foodfiltername}) === -1) {
//      datastorage.foodfiltername !== f._id) {
          continue;
      }

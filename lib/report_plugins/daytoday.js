...
//            text += '' + (f.carbs * f.portions).toFixed(1) + ' g';
            ...
            var text = 'posiłek nr ' + (fi + 1) + '/' + foods.length + ': nazwa: ' + f.name + ', porcja: ' + f.portions + ' ' + f.units + ', liczba porcji: ' + f.portionCount + ', carbs: ' + f.carbs + ', eCarbs: ' + f.ecarbs;
            if (datastorage.foodfiltername !== null && datastorage.foodfiltername === f._id) {
                context.append('text')

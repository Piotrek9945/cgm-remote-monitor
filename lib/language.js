...
function init() {
  ...
  var translations = {
    ...
    ,'Store hash on this computer (Use only on private computers)' : {
      ...
      ,ja: 'このコンピューターにハッシュ値を保存する(このコンピューターでのみ使用する)'
      ...
      ,tr: 'Bu bilgisayarda hash parolasını sakla (Yalnızca özel bilgisayarlarda kullanın)'
      ,zh_cn: '在本机存储API密钥\n（请勿在公用电脑上使用本功能）'
      ,zh_tw: '在本機存儲API密鑰\n（請勿在公用電腦上使用本功能）'
      }
    ,'Treatments' : {
    ...
    ,'Basal value' : { // absolute value for temp basal
      ...
      ,pl: 'Dawka podstawowa'
      ,pt: 'Valor da basal'
      ,ru: 'величина временного базалал'
      ,sk: 'Hodnota bazálu'
      ,nl: 'Basaal snelheid'
      ,ko: 'Basal'
      ,tr: 'Bazal değeri'
    ...
    ,'ISF' : {
      ...
      ,pt: 'ISF'
      ,nl: 'ISF'
      ,ru: 'Чувствительность к инсулину ISF'
      ,sk: 'ISF'
      ,ko: 'ISF'
      ,it: 'ISF'
      ,tr: 'ISF'
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, not accounting for carbs' : {
      ...
      ,ru: 'Избыток инсулина равного %1U, необходимого для достижения нижнего целевого значения, углеводы не учитываются'
    ...
    ,'Cannula change overdue!' : {
      ...
      ,ru: 'Срок работы катеттера истек'
    ...
    ,'Change cannula soon' : {
      ...
      ,ru: 'Подходит время замены катеттера'
   ...
   ,'Last Carbs' : {
    ...
    'alexaLoopNotAvailable': {
      ...
      , ru: 'плагин ЗЦ Loop не активирован '
    ...
    'alexaLoopForecast': {
      ...
      , ru: 'по прогнозу алгоритма ЗЦ ожидается %1 за последующие %2'
    ...
    'alexaCOB': {
      ...
      ,hr: '%1 %2 carbohydrates on board'
      , pl: '%1 %2 aktywnych węglowodanów'
      , ru: '%1 $2 активных углеводов'
      , tr: '%1 %2 aktif karbonhidrat'
    },
    'Fat [g]': {
        cs: 'Tuk [g]'
        ,de: 'Fett [g]'
